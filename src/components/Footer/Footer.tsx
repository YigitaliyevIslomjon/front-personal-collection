...
function Footer() {
  ...
  return (
    <AppBar
      ...
      className="px-7 py-7 sm:px-7 md:px-7 md:py-7"
    >
        ...
        <Grid container spacing={5}>
          ...
          >
            ...
            <Typography color="white" variant="body2">
              Personal Collection is a direct selling company that provides high
              quality products and livelihood through its dealership network.
            </Typography>
          </Grid>
          ...
          <Grid xs={12} sm={12} md={4}>
            <Typography color="white" variant="body2">
              Ground Floor, Triumph Building 1610 Quezon Avenue, Diliman, Quezon
